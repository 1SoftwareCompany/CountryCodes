...
namespace One.Iso3166.Tests
{
    ...
    public class SubdivisionTests
    {
        ...
        class when_serializing_subdivision
        {
            ...
            It should_be_equal = () => json.ShouldEqual("""{"$type":"One.Iso3166.Subdivision, One.CountryCodes","0":-1124723457}""");
        }
        ...
        class when_deserializing_subdivision
        {
            ...
            {
                var serializer = new TestJsonSerializer();
                us_al = serializer.Deserialize<Subdivision>("""{"$type":"One.Iso3166.Subdivision, One.CountryCodes","0":-1124723457}""");
            };
