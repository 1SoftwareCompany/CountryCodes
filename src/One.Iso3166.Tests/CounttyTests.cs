...
namespace One.Iso3166.Tests
{
    ...
    public class CountryTests
    {
        ...
        class when_serializing_country
        {
            ...
            It should_be_equal = () => json.ShouldEqual("""{"$type":"One.Iso3166.Country, One.CountryCodes","0":100}""");
        }
        ...
        class when_deserializing_country
        {
            ...
            {
                var serializer = new TestJsonSerializer();
                us = serializer.Deserialize<Country>("""{"$type":"One.Iso3166.Country, One.CountryCodes","0":840}""");
            };
